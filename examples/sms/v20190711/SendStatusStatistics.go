...
import (
	...
	sms "github.com/tencentyun/tcecloud-sdk-go/tcecloud/sms/v20190711" //引入sms
)
...
func main() {
	 ...
	 * 以免泄露密钥对危及你的财产安全。
	 * CAM密匙查询: https://console.cloud.tce.com/cam/capi*/
	 ...
	 * SDK提供对基本类型的指针引用封装函数
	 * 帮助链接：
	 * 短信控制台: https://console.cloud.tce.com/sms/smslist
	 * sms helper: https://cloud.tce.com/document/product/382/3773 */
