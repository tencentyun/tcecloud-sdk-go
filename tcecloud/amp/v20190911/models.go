...
func (r *UpdateShieldRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *UpdateShieldRequest) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}

type UpdateShieldResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
func (r *UpdateShieldResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *UpdateShieldResponse) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
