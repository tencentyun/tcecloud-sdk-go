...
func NewDescribeZoneDiskConfigInfos2Request() (request *DescribeZoneDiskConfigInfos2Request) {
    request = &DescribeZoneDiskConfigInfos2Request{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("cbs", APIVersion, "DescribeZoneDiskConfigInfos2")
    return
}

func NewDescribeZoneDiskConfigInfos2Response() (response *DescribeZoneDiskConfigInfos2Response) {
    response = &DescribeZoneDiskConfigInfos2Response{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 查询对应的云盘资源是否可以创建
func (c *Client) DescribeZoneDiskConfigInfos2(request *DescribeZoneDiskConfigInfos2Request) (response *DescribeZoneDiskConfigInfos2Response, err error) {
    if request == nil {
        request = NewDescribeZoneDiskConfigInfos2Request()
    }
    response = NewDescribeZoneDiskConfigInfos2Response()
    err = c.Send(request, response)
    return
}
