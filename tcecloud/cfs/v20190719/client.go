...
func NewAddMountTargetRequest() (request *AddMountTargetRequest) {
    request = &AddMountTargetRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("cfs", APIVersion, "AddMountTarget")
    return
}

func NewAddMountTargetResponse() (response *AddMountTargetResponse) {
    response = &AddMountTargetResponse{
...
// 用于创建挂载点
func (c *Client) AddMountTarget(request *AddMountTargetRequest) (response *AddMountTargetResponse, err error) {
    if request == nil {
        request = NewAddMountTargetRequest()
    }
    response = NewAddMountTargetResponse()
