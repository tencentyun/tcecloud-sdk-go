...
// 拉取配置绑定的server或location，如果domain存在，结果将根据domain过滤。
...
func NewDescribeCustomizedConfigContentRequest() (request *DescribeCustomizedConfigContentRequest) {
    request = &DescribeCustomizedConfigContentRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeCustomizedConfigContent")
    return
}

func NewDescribeCustomizedConfigContentResponse() (response *DescribeCustomizedConfigContentResponse) {
    response = &DescribeCustomizedConfigContentResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 拉取配置内容.
func (c *Client) DescribeCustomizedConfigContent(request *DescribeCustomizedConfigContentRequest) (response *DescribeCustomizedConfigContentResponse, err error) {
    if request == nil {
        request = NewDescribeCustomizedConfigContentRequest()
    }
    response = NewDescribeCustomizedConfigContentResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeCustomizedConfigLBAssociateListRequest() (request *DescribeCustomizedConfigLBAssociateListRequest) {
    request = &DescribeCustomizedConfigLBAssociateListRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeCustomizedConfigLBAssociateList")
    return
}

func NewDescribeCustomizedConfigLBAssociateListResponse() (response *DescribeCustomizedConfigLBAssociateListResponse) {
    response = &DescribeCustomizedConfigLBAssociateListResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 拉取LB下绑定的列表
func (c *Client) DescribeCustomizedConfigLBAssociateList(request *DescribeCustomizedConfigLBAssociateListRequest) (response *DescribeCustomizedConfigLBAssociateListResponse, err error) {
    if request == nil {
        request = NewDescribeCustomizedConfigLBAssociateListRequest()
    }
    response = NewDescribeCustomizedConfigLBAssociateListResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeSetByVipRequest() (request *DescribeSetByVipRequest) {
    request = &DescribeSetByVipRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeSetByVip")
    return
}

func NewDescribeSetByVipResponse() (response *DescribeSetByVipResponse) {
    response = &DescribeSetByVipResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 
func (c *Client) DescribeSetByVip(request *DescribeSetByVipRequest) (response *DescribeSetByVipResponse, err error) {
    if request == nil {
        request = NewDescribeSetByVipRequest()
    }
    response = NewDescribeSetByVipResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeSetCapacityRequest() (request *DescribeSetCapacityRequest) {
    request = &DescribeSetCapacityRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeSetCapacity")
    return
}

func NewDescribeSetCapacityResponse() (response *DescribeSetCapacityResponse) {
    response = &DescribeSetCapacityResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 
// 七层独占集群：QPS、连接数
func (c *Client) DescribeSetCapacity(request *DescribeSetCapacityRequest) (response *DescribeSetCapacityResponse, err error) {
    if request == nil {
        request = NewDescribeSetCapacityRequest()
    }
    response = NewDescribeSetCapacityResponse()
    err = c.Send(request, response)
    return
}
...
func NewDescribeSetVipRequest() (request *DescribeSetVipRequest) {
    request = &DescribeSetVipRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeSetVip")
    return
}

func NewDescribeSetVipResponse() (response *DescribeSetVipResponse) {
    response = &DescribeSetVipResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 通过集群名字查询vip
func (c *Client) DescribeSetVip(request *DescribeSetVipRequest) (response *DescribeSetVipResponse, err error) {
    if request == nil {
        request = NewDescribeSetVipRequest()
    }
    response = NewDescribeSetVipResponse()
    err = c.Send(request, response)
    return
}

func NewDescribeSetsRequest() (request *DescribeSetsRequest) {
    request = &DescribeSetsRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "DescribeSets")
    return
}

func NewDescribeSetsResponse() (response *DescribeSetsResponse) {
    response = &DescribeSetsResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
func (c *Client) DescribeSets(request *DescribeSetsRequest) (response *DescribeSetsResponse, err error) {
    if request == nil {
        request = NewDescribeSetsRequest()
    }
    response = NewDescribeSetsResponse()
    err = c.Send(request, response)
    return
}
...
func NewMigrateAppIdVIPRequest() (request *MigrateAppIdVIPRequest) {
    request = &MigrateAppIdVIPRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "MigrateAppIdVIP")
    return
}

func NewMigrateAppIdVIPResponse() (response *MigrateAppIdVIPResponse) {
    response = &MigrateAppIdVIPResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 跨开发商迁移负载均衡的VIP。
// 本接口为异步接口，本接口返回成功后需以返回的RequestID为入参，调用DescribeTaskStatus接口查询本次任务是否成功。
func (c *Client) MigrateAppIdVIP(request *MigrateAppIdVIPRequest) (response *MigrateAppIdVIPResponse, err error) {
    if request == nil {
        request = NewMigrateAppIdVIPRequest()
    }
    response = NewMigrateAppIdVIPResponse()
    err = c.Send(request, response)
    return
}
...
func NewQuerySetByVipRequest() (request *QuerySetByVipRequest) {
    request = &QuerySetByVipRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "QuerySetByVip")
    return
}

func NewQuerySetByVipResponse() (response *QuerySetByVipResponse) {
    response = &QuerySetByVipResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 一个vip的七层规则可能落在不同集群，根据vip+协议+vport来区分
// 
func (c *Client) QuerySetByVip(request *QuerySetByVipRequest) (response *QuerySetByVipResponse, err error) {
    if request == nil {
        request = NewQuerySetByVipRequest()
    }
    response = NewQuerySetByVipResponse()
    err = c.Send(request, response)
    return
}

func NewQuerySetCapacityRequest() (request *QuerySetCapacityRequest) {
    request = &QuerySetCapacityRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "QuerySetCapacity")
    return
}

func NewQuerySetCapacityResponse() (response *QuerySetCapacityResponse) {
    response = &QuerySetCapacityResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 
// 七层独占集群：QPS、连接数
func (c *Client) QuerySetCapacity(request *QuerySetCapacityRequest) (response *QuerySetCapacityResponse, err error) {
    if request == nil {
        request = NewQuerySetCapacityRequest()
    }
    response = NewQuerySetCapacityResponse()
    err = c.Send(request, response)
    return
}

func NewQuerySetVipRequest() (request *QuerySetVipRequest) {
    request = &QuerySetVipRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "QuerySetVip")
    return
}

func NewQuerySetVipResponse() (response *QuerySetVipResponse) {
    response = &QuerySetVipResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 通过集群名字查询vip
func (c *Client) QuerySetVip(request *QuerySetVipRequest) (response *QuerySetVipResponse, err error) {
    if request == nil {
        request = NewQuerySetVipRequest()
    }
    response = NewQuerySetVipResponse()
    err = c.Send(request, response)
    return
}
...
func NewSetLoadBalancerExclusiveTagRequest() (request *SetLoadBalancerExclusiveTagRequest) {
    request = &SetLoadBalancerExclusiveTagRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    request.Init().WithApiInfo("clb", APIVersion, "SetLoadBalancerExclusiveTag")
    return
}

func NewSetLoadBalancerExclusiveTagResponse() (response *SetLoadBalancerExclusiveTagResponse) {
    response = &SetLoadBalancerExclusiveTagResponse{
        BaseResponse: &tchttp.BaseResponse{},
    }
    return
}
...
// 设置负载均衡七层集群的独占标签。
func (c *Client) SetLoadBalancerExclusiveTag(request *SetLoadBalancerExclusiveTagRequest) (response *SetLoadBalancerExclusiveTagResponse, err error) {
    if request == nil {
        request = NewSetLoadBalancerExclusiveTagRequest()
    }
    response = NewSetLoadBalancerExclusiveTagResponse()
    err = c.Send(request, response)
    return
}
