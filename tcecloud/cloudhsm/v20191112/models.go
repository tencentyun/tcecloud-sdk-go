...
type DescribeRegionsResponse struct {
	*tchttp.BaseResponse
	Response *struct {
		...
		// 地域列表
		Regions []*RegionInfo `json:"Regions,omitempty" name:"Regions" list`
...
type RegionInfo struct {
	...
	// 地域中文编码
	RegionCnCode *string `json:"RegionCnCode,omitempty" name:"RegionCnCode"`

	// 地域英文编码
	RegionEnCode *string `json:"RegionEnCode,omitempty" name:"RegionEnCode"`
...
type TerminateVsmRequest struct {
	*tchttp.BaseRequest
...
func (r *TerminateVsmRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *TerminateVsmRequest) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}

type TerminateVsmResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
func (r *TerminateVsmResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *TerminateVsmResponse) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
...
type ZoneInfo struct {
	...
	// 可用区英文编码
	ZoneEnCode *string `json:"ZoneEnCode,omitempty" name:"ZoneEnCode"`

	// 可用区中文编码
	ZoneCnCode *string `json:"ZoneCnCode,omitempty" name:"ZoneCnCode"`
}
